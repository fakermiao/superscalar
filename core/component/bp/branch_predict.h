 ...
 * @LastEditors: 苗金标
 * @LastEditTime: 2023-05-24 15:42:58
 * @Description: 
 */
/*
...
namespace component{
class branch_predictor : public baseBp{
    public:
        ...
        void gshare_update_prediction(uint64_t pc,bool jump,bool hit,uint32_t global_history_recover){
            uint64_t pc_p1 = (pc >> 2) & GSHARE_PC_ADDR_MASK;
        ...
        void local_update_prediction(uint64_t pc,bool jump){
            uint64_t pc_p1 = (pc >> 2) & LOCAL_PC_ADDR_MASK;
        ...
        void call_update_prediction(uint64_t pc,bool jump,uint64_t target){
            uint64_t pc_p1 = (pc >> 2) & CALL_PC_ADDR_MASK;
        ...
        void normal_update_prediction(uint64_t pc,bool jump,uint64_t target){
            uint64_t pc_p1 = (pc >> 2) & NORMAL_PC_ADDR_MASK;
        ...
        void update_prediction(uint64_t pc,uint32_t inst,bool jump,uint64_t next_pc,bool hit,uint32_t global_history_recover){
            auto rd = (inst >> 7) & 0x1f;
